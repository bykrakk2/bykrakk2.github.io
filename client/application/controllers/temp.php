<?php
class temp extends FE_Controller
{
    ...
    public function index($id = NULL)
    {
        ...
        if ($cat == "") {
            $this->data['pagination'] = $this->pagination($count, $curp, '/category/' . $this->uri->segment(2) . '/p/', 4, $per);
        }
        $this->data['subview'] = 'temp';
