...
$uploadscript = <<<HTML
	new qq.FileUploader({
	    ...
	    params: {"PHPSESSID" : "{$sess_id}", "subaction" : "upload", "news_id" : "{$row['id']}", "area" : "xfieldsimage", "author" : "{$author}", "xfname" : "{$fieldname}", "user_hash" : "{$dle_login_hash}"},
...
$uploadscript = <<<HTML
	...
	var uploader_{$fieldcount} = new qq.FileUploader({
	    ...
	    params: {"PHPSESSID" : "{$sess_id}", "subaction" : "upload", "news_id" : "{$row['id']}", "area" : "xfieldsimagegalery", "author" : "{$author}", "xfname" : "{$fieldname}", "user_hash" : "{$dle_login_hash}"},
        template: '<div class="qq-uploader">' + 
                '<div id="uploadedfile_{$fieldname}">{$up_image}</div><div class="qq-upload-drop-area"><span>{$lang['media_upload_st5']}</span></div>' +
...
$uploadscript = <<<HTML
	new qq.FileUploader({
	    ...
	    params: {"PHPSESSID" : "{$sess_id}", "subaction" : "upload", "news_id" : "{$row['id']}", "area" : "xfieldsfile", "author" : "{$author}", "xfname" : "{$fieldname}", "user_hash" : "{$dle_login_hash}"},
        template: '<div class="qq-uploader">' + 
...
var text_upload = "$lang[bb_t_up]";
      ...
      $.ajax({
           url: dle_root + 'engine/skins/codemirror/js/code.js',
           dataType: 'script',
           cache: true,
      });
