    ...
    function save(){
		...
		$('#dlepopup').dialog({
			...
			open: function(event, ui) { 
				$("#dlepopup").html("<iframe width='99%' height='220' src='?mod=dumper&user_hash={$dle_login_hash}&action=backup&comp_method=" + $("#comp_method").val() + "&rndval=" + rndval + "' frameborder='0' marginwidth='0' marginheight='0' scrolling='no'></iframe>");
			},
...
<script type="text/javascript">
    function dbload(){
		...
		$('#dlepopup').dialog({
			...
			open: function(event, ui) { 
				$("#dlepopup").html("<iframe width='99%' height='220' src='?mod=dumper&user_hash={$dle_login_hash}&action=restore&file=" + $("#file").val() + "&rndval=" + rndval + "' frameborder='0' marginwidth='0' marginheight='0' scrolling='no'></iframe>");
			},
			beforeClose: function(event, ui) { 
				$("#dlepopup").html("");
			},
