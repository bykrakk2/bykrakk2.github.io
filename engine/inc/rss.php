...
<script type="text/javascript">
	...
	function doFull( link, news_id, rss_id )
	{
		...
		$.post('engine/ajax/rss.php', { link: link, news_id: news_id, rss_id: rss_id, user_hash: '{$dle_login_hash}', rss_charset: "{$xml->rss_charset}" }, function(data){
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<textarea style="width:100%;max-width:350px;" rows="5" name="rss_search">{$rss_search_value}</textarea>&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['rss_hsearch']}" >?</span>
		  </div>
		 </div>	
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['rss_cookie']}</label>
		  <div class="col-lg-10">
			<textarea style="width:100%;max-width:350px;" rows="5" name="rss_cookie">{$rss_cookie_value}</textarea>&nbsp;<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="right" data-content="{$lang['rss_hcookie']}" >?</span>
		  </div>
		 </div>	
		<div class="form-group">
