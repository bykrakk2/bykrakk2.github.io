...
function senden( startfrom ){
	...
	$.post("engine/ajax/newsletter.php", { startfrom: startfrom, title: title, message: message, user_hash: '{$dle_login_hash}', type: '{$type}', empfanger: '{$empfanger}', a_mail: '{$a_mail}', limit: '{$limit}', fromregdate: '{$fromregdate}', toregdate: '{$toregdate}', fromentdate: '{$fromentdate}', toentdate: '{$toentdate}'  },
		function(data){
...
echo <<<HTML
			<br><br>{$lang['nl_info_1']} {$lang['nl_info_2']}
		  </div>
		</div>
		<div class="form-group">
...
<div class="box">
  ...
  <div class="box-content">
	...
	<div class="row box-section">
		...
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['edit_regdate']}</label>
		  <div class="col-lg-10">
			{$lang['edit_fdate']}&nbsp;<input data-rel="calendardate" type="text" name="fromregdate" id="fromregdate" size="17" maxlength="16" value="">
			{$lang['edit_tdate']}&nbsp;<input data-rel="calendardate" type="text" name="toregdate" id="toregdate" size="17" maxlength="16" value="">
		  </div>
		 </div>
		<div class="form-group">
		  <label class="control-label col-lg-2">{$lang['edit_entedate']}</label>
		  <div class="col-lg-10">
			{$lang['edit_fdate']}&nbsp;<input data-rel="calendardate" type="text" name="fromentdate" id="fromentdate" size="17" maxlength="16" value="">
			{$lang['edit_tdate']}&nbsp;<input data-rel="calendardate" type="text" name="toentdate" id="toentdate" size="17" maxlength="16" value="">
		   </div>
		 </div>
		<div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-lg-10">
			<input type="checkbox" name="a_mail" value="1" class="icheck" checked>
		  </div>
		 </div>			 
		<div class="form-group">
		  <label class="control-label col-lg-2"></label>
