...
jQuery(function($){
	...
	$('#filetree').fileTree({ root: '{$do_template}/', script: 'engine/ajax/templates.php?user_hash={$dle_login_hash}', folderEvent: 'click', expandSpeed: 750, collapseSpeed: 750, multiFolder: false }, function(file) { 
