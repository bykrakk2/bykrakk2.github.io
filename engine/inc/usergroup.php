...
<table class="table table-normal table-hover settingsgr">
   ...
   <tr>
    ...
    <tr>
        <td><h6>{$lang['group_reglim']}</h6><span class="note large">{$lang['group_reglimd']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="force_reg" {$force_reg} value="1" {$admingroup}{$gastgroup}>
			{$lang['force_group_days']}<br />
			<input type="text" size="20" name="force_reg_days" value="{$force_reg_days}">
			<br />{$lang['force_group']}<br />
    ...
    <tr>
        <td><h6>{$lang['group_nlim']}</h6><span class="note large">{$lang['group_nlimd']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="force_news" {$force_news} value="1" {$admingroup}{$gastgroup}>
			{$lang['force_group_news']}<br />
			<input type="text" size="20" name="force_news_count" value="{$force_news_count}">
			<br />{$lang['force_group']}<br />
    ...
    <tr>
        <td><h6>{$lang['group_clim']}</h6><span class="note large">{$lang['group_climd']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="force_comments" {$force_comments} value="1" {$admingroup}{$gastgroup}>
			{$lang['force_group_comm']}<br />
			<input type="text" size="20" name="force_comments_count" value="{$force_comments_count}">
			<br />{$lang['force_group']}<br />
    ...
    <tr>
        <td><h6>{$lang['group_ratelim']}</h6><span class="note large">{$lang['group_ratelimd']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="force_rating" {$force_rating} value="1" {$admingroup}{$gastgroup}>
			{$lang['force_group_rating']}<br />
			<input type="text" size="20" name="force_rating_count" value="{$force_rating_count}">
			<br />{$lang['force_group']}<br />
    ...
    <tr>
        <td><h6>{$lang['group_fuf']}</h6><span class="note large">{$lang['group_fufd']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="allow_mail_files" {$allow_mail_files} value="1"></td>
    </tr>
    <tr>
        <td><h6>{$lang['group_fuf2']}</h6><span class="note large">{$lang['group_fufd2']}</span></td>
        <td><input type="text" size="20" name="max_mail_files" value="{$max_mail_files_value}"></td>
    </tr>
    <tr>
        <td><h6>{$lang['group_fuf3']}</h6><span class="note large">{$lang['group_fufd3']}</span></td>
        <td><input type="text" size="20" name="max_mail_allfiles" value="{$max_mail_allfiles_value}"></td>
    </tr>
    <tr>
        <td><h6>{$lang['group_fuf4']}</h6><span class="note large">{$lang['group_fufd4']}</span></td>
        <td><input type="text" name="mail_files_type" value="{$mail_files_type_value}" style="width:100%; max-width:350px;"></td>
    </tr>
    <tr>
...
{$categories_list}
    ...
    <tr>
        <td class="white-line" style="width:58%"><h6>{$lang['group_nct']}</h6><span class="note large">{$lang['group_nctd']}</span></td>
...
{$cat_add_list}
    ...
    <tr>
        ...
        <td><input type="text" name="files_type" value="{$files_type_value}" style="width:100%; max-width:350px;"></td>
    </tr>
...
<table class="table table-normal table-hover settingsgr">
    ...
    <tr>
        <td><h6>{$lang['group_up_image']}</h6><span class="note large">{$lang['hint_group_up_image']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="allow_up_image" {$allow_up_image} value="1" {$gastgroup}></td>
    </tr>
    <tr>
        <td><h6>{$lang['group_up_count_image']}</h6><span class="note large">{$lang['hint_up_count_image']}</span></td>
        <td><input type="text" size="20" name="up_count_image" value="{$up_count_image_value}"></td>
    </tr>
    <tr>
        <td><h6>{$lang['xfield_xi1']}</h6><span class="note large">{$lang['xfield_xi2']}</span></td>
        <td><input type="text" size="20" name="up_image_side" value="{$up_image_side_value}"></td>
    </tr>
    <tr>
        <td><h6>{$lang['xfield_xi3']}</h6><span class="note large">{$lang['xfield_xi4']}</span></td>
        <td><input type="text" size="20" name="up_image_size" value="{$up_image_size_value}"></td>
    </tr>
    <tr>
        <td><h6>{$lang['xfield_xi5']}</h6><span class="note large">{$lang['hint_up_watermark']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="allow_up_watermark" {$allow_up_watermark} value="1" {$gastgroup}></td>
    </tr>
    <tr>
        <td><h6>{$lang['xfield_xi6']}</h6><span class="note large">{$lang['hint_up_thumb']}</span></td>
        <td><input class="iButton-icons-tab" type="checkbox" name="allow_up_thumb" {$allow_up_thumb} value="1" {$gastgroup}></td>
    </tr>
    <tr>
        <td><h6>{$lang['xfield_xi7']}</h6><span class="note large">{$lang['xfield_xi8']}</span></td>
        <td><input type="text" size="20" name="up_thumb_size" value="{$up_thumb_size_value}"></td>
    </tr>
