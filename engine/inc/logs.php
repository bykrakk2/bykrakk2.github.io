	...
	<ul class="box-toolbar">
      <li>
        <label class="input-with-submit">
          <input type="text" name="searchword" placeholder="{$lang['search_field']}" onchange="document.navi.start_from.value=0;" style="width: 230px;" value="{$searchword}">
...
HTML;
	...
	if ( $searchword ) {
		...
		if( $date ) {
			...
			$where[] = "(name like '%$searchword%' OR ip like '%$searchword%'{$date})";
		}
	}
