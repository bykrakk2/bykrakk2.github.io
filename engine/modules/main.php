...
$ajax .= <<<HTML
echo "\n<!-- DataLife Engine Copyright SoftNews Media Group (http://dle-news.ru).  Создатель шаблона DRIP (https://drip.site)-->\r\n";
{$pm_alert}{$twofactor_alert}<script type="text/javascript">
<!--
...
if ($allow_comments_ajax AND ($config['allow_quick_wysiwyg'] == "1" OR $config['allow_comments_wysiwyg'] == "1")) {
