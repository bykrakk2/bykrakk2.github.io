...
if( isset( $_POST['send'] ) and !$stop_pm ) {
	...
	$subj = $db->safesql( $parse->process( trim( strip_tags($_POST['subj']) ) ) );
...
function dlePMPreview(){ 
	...
	$.post(dle_root + "engine/ajax/pm.php", { text: pm_text, name: name, subj: subj, skin: dle_skin, user_hash: '{$dle_login_hash}' }, function(data){
